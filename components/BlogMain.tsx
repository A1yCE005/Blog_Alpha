...
export function BlogMain({ visible, posts }: BlogMainProps) {
  ...
  return (
    <>
      ...
      >
        <div
          className={`mx-auto flex min-h-full w-full max-w-4xl flex-col gap-10 px-6 pt-16 pb-[calc(4rem_+_var(--safe-area-inset-bottom))] transition-transform duration-300 ease-out sm:px-10 ${
