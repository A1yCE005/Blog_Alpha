...
export default function FullscreenHome({ posts, initialBlogView = false }: FullscreenHomeProps) {
  ...
  return (
    <div className="min-h-screen bg-black pb-safe text-zinc-100">
      {!heroRetired && (
        <section
          className={`relative h-[100svh] w-full overflow-hidden pb-safe transition-all duration-700 ease-out ${
