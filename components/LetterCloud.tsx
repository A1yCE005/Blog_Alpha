          ...
          if (phase === "drop") {
            ...
            const transitionScale =
              activeTransitionMs > 0
                ? Math.min(1, (baseTransitionMs || 1) / activeTransitionMs)
                : 1;
            const scaledBaseK = baseK * transitionScale;
            const scaledGainK = gainK * transitionScale;
            const kNow = scaledBaseK + easeInOut(tLocal) * scaledGainK;
