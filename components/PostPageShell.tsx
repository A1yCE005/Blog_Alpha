...
export function PostPageShell({ slug, backHref, children }: PostPageShellProps) {
  const resetKey = `post:${slug}`;
  ...
  return (
    <>
      <div
        aria-hidden
        className={`page-transition-overlay ${isTransitioning ? "page-transition-overlay-active" : ""}`.trim()}
      />
      <div
