...
export function StormPageContent({ quotes }: StormPageContentProps) {
  ...
  const applyHighlightToCenter = useCallback(
    (options?: { animate?: boolean }) => {
      ...
      const highlightChanged = highlightedIdRef.current !== nearestId;
      const willAnimate = Boolean(options?.animate);
      const shouldGuardScroll = highlightChanged || willAnimate;
