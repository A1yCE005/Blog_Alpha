...
function StormQuoteCard({
  ...
  const baseTextClasses =
    "max-w-3xl whitespace-pre-line text-center text-[1.5rem] font-bold leading-[1.6] tracking-[0.015em] transition-all duration-500 ease-out sm:text-[1.9rem] md:text-[2.15rem]";
