...
const PAGE_FADE_IN_DURATION_MS = 600;
const INITIAL_HIGHLIGHT_EXTRA_DELAY_MS = 400;
const INITIAL_HIGHLIGHT_DELAY_MS =
  PAGE_FADE_IN_DURATION_MS + INITIAL_HIGHLIGHT_EXTRA_DELAY_MS;
