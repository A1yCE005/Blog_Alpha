...
export const metadata: Metadata = {
  title: "About · Letter Cloud Blog",
  description: aboutPost.excerpt,
};

export default function AboutPage() {
  return <PostPageContent post={aboutPost} />;
}
