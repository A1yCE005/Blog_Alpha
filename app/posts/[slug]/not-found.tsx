...
export default function PostNotFound() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`mx-auto flex min-h-screen w-full max-w-3xl flex-col items-center justify-center px-6 py-20 text-center text-zinc-200 transition-transform duration-300 ease-out sm:px-10 ${
