...
export default function PostNotFound() {
  ...
  return (
    <>
      ...
      />
      <div
        className={`relative flex min-h-screen items-center justify-center bg-black page-fade-in transition-opacity duration-300 ease-out ${
          isInteractive ? "pointer-events-auto opacity-100" : "pointer-events-none opacity-0"
        }`}
      >
        <div className="mx-auto flex w-full max-w-3xl flex-col items-center px-6 py-20 text-center text-zinc-200 sm:px-10">
