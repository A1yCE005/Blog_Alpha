...
export default function PostNotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-black px-6 pt-20 pb-[calc(5rem_+_var(--safe-area-inset-bottom))] text-center text-zinc-200">
