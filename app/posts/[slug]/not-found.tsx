...
export default function PostNotFound() {
  ...
  return (
    <>
      ...
      />
      <div
        className={`relative flex min-h-screen flex-col items-center justify-center bg-black px-6 py-20 text-center text-zinc-200 page-fade-in transition-opacity duration-300 ease-out ${
