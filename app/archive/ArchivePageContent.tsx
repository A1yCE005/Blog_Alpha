...
export function ArchivePageContent({
  ...
  return (
    <>
      ...
      />
      <div
        className={`relative min-h-screen bg-black pb-[env(safe-area-inset-bottom)] page-fade-in transition-opacity duration-300 ease-out [@supports(height:100dvh)]:min-h-[100dvh] ${
