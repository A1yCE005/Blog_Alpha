...
export function ArchivePageContent({
  ...
  return (
    <>
      ...
      />
      <div
        className={`relative min-h-screen bg-black pb-safe page-fade-in transition-opacity duration-300 ease-out ${
          isTransitioning ? "pointer-events-none opacity-0" : "opacity-100"
        }`}
      >
        <div
          className={`mx-auto flex min-h-screen w-full max-w-4xl flex-col gap-10 px-6 pt-16 pb-[calc(4rem_+_var(--safe-area-inset-bottom))] transition-transform duration-300 ease-out sm:px-10 ${
